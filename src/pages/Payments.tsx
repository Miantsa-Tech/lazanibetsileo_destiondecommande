  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 dark:text-slate-100">Règlements</h1>
          <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">{reglements.length} règlements enregistrés</p>
        </div>
